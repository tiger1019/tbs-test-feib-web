...
public class SwaggerConfig {
  ...
  private static final String API_PKG = "com.feib.business.api.controller";
  private static final String API_TITLE = "FEIB CreditCard Business API, 信用卡業務服務.";
  private static final String API_DESC = "信用卡業務服務.";
